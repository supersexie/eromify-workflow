    ...
    <>
      <div className="topbar">
        ...
        <div className="topbar-right">
          ...
          <button className="assistant-open-btn" onClick={() => setAssistantOpen(true)} title="Open Romy — your creative assistant">
      ...
      {!assistantOpen && (
        <button className="assistant-fab" onClick={() => setAssistantOpen(true)} title="Open Romy">
