          ...
          <div className="ip-bar-input-row">
            ...
            <button className="up-source" onClick={() => fileRef.current?.click()} disabled={running}>
              {source ? (
                ...
                // Video icon when upscaling video
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="5" width="18" height="14" rx="2"/><polygon points="10 9 16 12 10 15 10 9" fill="currentColor" stroke="none"/></svg>
              ) : (
                // Image icon when upscaling an image
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-5-5L5 21"/></svg>
              )}
            </button>
