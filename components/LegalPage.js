...
// Shared shell for the static legal/policy pages. Own scroll container (the
// global body{overflow:hidden} for the canvas would otherwise clip it) + SF Pro.
// Every page renders the DRAFT banner — these are scaffolding to satisfy the
// CCBill footer-link requirements and must be replaced with counsel-reviewed
// text before launch.
