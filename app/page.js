...
const CHARS = [
  ...
  { name: "Luna", faded: false, bg: G.blue, imgs: ["/chars/luna-1.jpg","/chars/luna-2.jpg","/chars/luna-3.jpg","/chars/luna-4.jpg","/chars/luna-5.jpg","/chars/luna-6.jpg"] },
];
  ...
  return (
    <div className={`${geistSans.variable} ${bricolage.variable} min-h-screen bg-[#0A0A0A] text-[#B8B8B8]`} style={{ fontFamily: "var(--font-geist-sans), sans-serif" }}>
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <section id="features" className="max-w-[1440px] mx-auto w-full px-6 md:px-16 py-24 grid grid-cols-1 md:grid-cols-[1fr_1.4fr] gap-10 md:gap-16 items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.6fr_1fr] gap-4">
            <div className="flex flex-col gap-4">
              {BENTO_WIDE.map((t) => (
                <div key={t.label} className="relative aspect-[21/9] rounded-[20px] border border-white/[0.06] overflow-hidden hover:border-[rgba(236,72,153,0.4)] hover:scale-[1.01] transition-all duration-[250ms] bg-[#0f0a10]">
            ...
            <div className="flex flex-col gap-4">
              {BENTO_SIDE.map((t) => (
                <div key={t.label} className="relative flex-1 min-h-[140px] rounded-[20px] border border-white/[0.06] overflow-hidden hover:border-[rgba(236,72,153,0.4)] hover:scale-[1.01] transition-all duration-[250ms] bg-[#0f0a10]">
                  {t.img ? (
                    <img src={t.img} alt={t.label} className="absolute inset-0 w-full h-full object-cover" />
                  ) : (
        ...
        {/* Character gallery */}
        <section id="characters" className="max-w-[1440px] mx-auto w-full flex flex-col md:flex-row items-start px-6 md:px-16 py-24 gap-8 md:gap-20">
